...
namespace VolleyMS.Core.Repositories
{
    public interface IClubRepository : IGenericRepository<Club>
    {
        ...
        Task<IList<JoinClubRequest>> GetAllJoinRequestsAsync(Guid clubId, CancellationToken cancellation);
        Task<JoinClubRequest?> GetJoinRequestByIdAsync(Guid joinRequestId, CancellationToken cancellation);
    }
}
